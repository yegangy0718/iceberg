...
public class TestAggregatedDataStatistics {

  @Test
  public void mergeDataStatisticTest() {
    AggregatedDataStatistics<String> aggregatedDataStatistics =
        new AggregatedDataStatistics<>(1, MapDataStatistics::new);
    DataStatistics<String> mapDataStatistics1 = new MapDataStatistics<>();
    mapDataStatistics1.add("a");
    mapDataStatistics1.add("a");
    mapDataStatistics1.add("b");
    aggregatedDataStatistics.mergeDataStatistic(
    ...
    Assertions.assertEquals(
        3L,
        (long)
            ((MapDataStatistics<String>) aggregatedDataStatistics.dataStatistics())
                .dataStatistics()
                .get("a"));
    Assertions.assertEquals(
        1L,
