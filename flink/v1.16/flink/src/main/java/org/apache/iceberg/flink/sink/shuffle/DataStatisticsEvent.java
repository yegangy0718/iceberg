...
/**
 * DataStatisticsEvent contains data statistics collected by every data statistics operator subtask
 * and will be sent to data statistics coordinator for global aggregation
 */
